...
typedef void (*HashTable_collect_f)(void *state, HashTable *H, void *ptr);
...
int HashTable_freev(HashTable* H, HashTable_collect_f freefn, void* state);
...
size_t HashTable_collectentries(HashTable *H, HashTable_collect_f fn, void *state);
size_t HashTable_collectobjects(HashTable *H, HashTable_collect_f fn, void *state);
